...
class MonoDataset(data.Dataset):
    ...
    def preprocess(self, inputs, color_aug, height_re_HiS, width_re_HiS, height_re_LoS, width_re_LoS, dx_HiS, dy_HiS, do_crop_aug):
        ...
        for k in list(inputs):
            ...
            if "color_LoS" in k:
                ...
                #Tensor_LoS[:, height_re_LoS:self.height, 0:width_re_LoS] = 1
                #Tensor_LoS[:, 0:height_re_LoS, width_re_LoS:self.width] = 1
                #Tensor_LoS[:, height_re_LoS:self.height, width_re_LoS:self.width] = 1
    ...
    def __getitem__(self, index):
        ...
        for scale in range(self.num_scales):
            ...
            inputs[("K_int", scale)] = torch.from_numpy(intrinsics) #导出3*3的内参 没用上
